...
function Code({ code }) {
  ...
  return (
    <>
      <ConfirmDialog
        message=" Voulez_vous suppression l'enregistrement ?"
        title="SUPPRIMER"
        opened={false}
      />
        ...
        {isNew ? (
          ...
          <>
            ...
            {!isUpdate ? (
              ...
              <Button onClick={updatPost} variant="contained" color="primary">
                Modifier
              </Button>
            )}
          </>
        ...
        <>
          <Stack direction="row">
            ...
            <Stack sx={theme2.titles}>
              ...
              <label>
                <input ref={categoryRef} type="text" defaultValue={category} />
              </label>
              <label>
                <input
                  ref={titleRef}
